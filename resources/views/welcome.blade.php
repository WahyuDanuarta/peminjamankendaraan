...
<head>
    ...
    <!-- Favicon-->
    <link rel="shortcut icon" href="{{ asset('assets/templates/admin/img/logossk.png') }}">
    <!-- Author Meta -->
    ...
    <section class="login_box_area section_gap">
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
                    <div class="">
                        <img class="img-fluid" src="{{ asset('assets/templates/admin/img/skbaru.png') }}" alt="">
                        <div class="hover">
                            <h4></h4>
                            <p></p>
                        </div>
